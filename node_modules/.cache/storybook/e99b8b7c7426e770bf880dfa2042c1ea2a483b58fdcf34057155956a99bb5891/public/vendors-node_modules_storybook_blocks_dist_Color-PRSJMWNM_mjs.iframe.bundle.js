(self["webpackChunkexample_component_library"] = self["webpackChunkexample_component_library"] || []).push([["vendors-node_modules_storybook_blocks_dist_Color-PRSJMWNM_mjs"],{
...
var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled.div({
    position: "relative",
    maxWidth: 250,
    '&[aria-readonly="true"]': {
      opacity: .5
  ...
  PickerTooltip = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled)(_storybook_components__WEBPACK_IMPORTED_MODULE_4__.WithTooltip)({
    position: "absolute",
    zIndex: 1,
    top: 4,
    left: 4,
  ...
  TooltipContent = _storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled.div({
    width: 200,
    margin: 5,
  ...
  Note = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled)(_storybook_components__WEBPACK_IMPORTED_MODULE_4__.TooltipNote)(({
    theme
  }) => ({
    fontFamily: theme.typography.fonts.base
  })),
  Swatches = _storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled.div({
    display: "grid",
  ...
  SwatchColor = _storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled.div(({
    theme,
    active
  }) => ({
    width: 16,
  ...
  Input = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled)(_storybook_components__WEBPACK_IMPORTED_MODULE_4__.Form.Input)(({
    theme,
    readOnly
  }) => ({
    width: "100%",
  ...
  ToggleIcon = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_3__.styled)(_storybook_icons__WEBPACK_IMPORTED_MODULE_5__.MarkupIcon)(({
    theme
  }) => ({
    position: "absolute",
    zIndex: 1,
  ...
  ColorPicker = {
    hex: react_colorful__WEBPACK_IMPORTED_MODULE_6__.HexColorPicker,
    rgb: react_colorful__WEBPACK_IMPORTED_MODULE_6__.RgbaStringColorPicker,
    hsl: react_colorful__WEBPACK_IMPORTED_MODULE_6__.HslaStringColorPicker
  },
  fallbackColor = {
    hex: "transparent",
    rgb: "rgba(0, 0, 0, 0)",
  ...
  parseValue = value => {
    ...
    if (RGB_REGEXP.test(value)) {
      let [r, g, b, a] = stringToArgs(value),
        [h, s, l] = color_convert__WEBPACK_IMPORTED_MODULE_1___default().rgb.hsl([r, g, b]) || [0, 0, 0];
      return {
        valid,
        value,
        keyword: color_convert__WEBPACK_IMPORTED_MODULE_1___default().rgb.keyword([r, g, b]),
        colorSpace: "rgb",
        rgb: value,
        hsl: `hsla(${h}, ${s}%, ${l}%, ${a})`,
        hex: `#${color_convert__WEBPACK_IMPORTED_MODULE_1___default().rgb.hex([r, g, b]).toLowerCase()}`
      };
    }
    if (HSL_REGEXP.test(value)) {
      let [h, s, l, a] = stringToArgs(value),
        [r, g, b] = color_convert__WEBPACK_IMPORTED_MODULE_1___default().hsl.rgb([h, s, l]) || [0, 0, 0];
      return {
        valid,
        value,
        keyword: color_convert__WEBPACK_IMPORTED_MODULE_1___default().hsl.keyword([h, s, l]),
        colorSpace: "hsl",
        rgb: `rgba(${r}, ${g}, ${b}, ${a})`,
        hsl: value,
        hex: `#${color_convert__WEBPACK_IMPORTED_MODULE_1___default().hsl.hex([h, s, l]).toLowerCase()}`
      };
    }
    let plain = value.replace("#", ""),
      rgb = color_convert__WEBPACK_IMPORTED_MODULE_1___default().keyword.rgb(plain) || color_convert__WEBPACK_IMPORTED_MODULE_1___default().hex.rgb(plain),
      hsl = color_convert__WEBPACK_IMPORTED_MODULE_1___default().rgb.hsl(rgb),
      mapped = value;
    if (/[^#a-f0-9]/i.test(value) ? mapped = plain : HEX_REGEXP.test(value) && (mapped = `#${plain}`), mapped.startsWith("#")) valid = HEX_REGEXP.test(mapped);else try {
      color_convert__WEBPACK_IMPORTED_MODULE_1___default().keyword.hex(mapped);
    } catch {
      valid = !1;
    }
    return {
      valid,
      value: mapped,
      keyword: color_convert__WEBPACK_IMPORTED_MODULE_1___default().rgb.keyword(rgb),
      colorSpace: "hex",
  ...
  getRealValue = (value, color, colorSpace) => {
    ...
    if (!color.hex.startsWith("#")) try {
      return `#${color_convert__WEBPACK_IMPORTED_MODULE_1___default().keyword.hex(color.hex)}`;
    } catch {
  ...
  useColorInput = (initialValue, onChange) => {
    let [value, setValue] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialValue || ""),
      [color, setColor] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(() => parseValue(value)),
      [colorSpace, setColorSpace] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(color?.colorSpace || "hex");
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
      let nextValue = initialValue || "",
        nextColor = parseValue(nextValue);
      setValue(nextValue), setColor(nextColor), setColorSpace(nextColor?.colorSpace || "hex");
    }, [initialValue]);
    let realValue = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => getRealValue(value, color, colorSpace).toLowerCase(), [value, color, colorSpace]),
      updateValue = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(update => {
      ...
      cycleColorSpace = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
  ...
  usePresets = (presetColors, currentColor, colorSpace) => {
    let [selectedColors, setSelectedColors] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(currentColor?.valid ? [currentColor] : []);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
      currentColor === void 0 && setSelectedColors([]);
    }, [currentColor]);
    let presets = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => (presetColors || []).map(preset => typeof preset == "string" ? parseValue(preset) : preset.title ? {
      ...
      addPreset = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(color => {
  ...
  ColorControl = ({
    ...
    let throttledOnChange = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(lodash_throttle_js__WEBPACK_IMPORTED_MODULE_2___default()(onChange, 200), [onChange]),
      {
        value,
        realValue,
        updateValue,
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Wrapper, {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_0__.createElement(PickerTooltip, {
      startOpen,
      trigger: readonly ? [null] : void 0,
      closeOnOutsideClick: !0,
      onVisibleChange: () => addPreset(color),
      tooltip: react__WEBPACK_IMPORTED_MODULE_0__.createElement(TooltipContent, null, react__WEBPACK_IMPORTED_MODULE_0__.createElement(Picker, {
        color: realValue === "transparent" ? "#000000" : realValue,
        onChange: updateValue,
        onFocus,
        onBlur
      }), presets.length > 0 && react__WEBPACK_IMPORTED_MODULE_0__.createElement(Swatches, null, presets.map((preset, index) => react__WEBPACK_IMPORTED_MODULE_0__.createElement(_storybook_components__WEBPACK_IMPORTED_MODULE_4__.WithTooltip, {
        key: `${preset.value}-${index}`,
        hasChrome: !1,
        tooltip: react__WEBPACK_IMPORTED_MODULE_0__.createElement(Note, {
      ...
      id: (0,_chunk_GWAJ4KRU_mjs__WEBPACK_IMPORTED_MODULE_7__.getControlId)(name),
      value,
      onChange: e => updateValue(e.target.value),
      onFocus: e => e.target.select(),
      readOnly: readonly,
      placeholder: "Choose color..."
    }), value ? react__WEBPACK_IMPORTED_MODULE_0__.createElement(ToggleIcon, {
...
function i(e) {
  var t = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(e),
    n = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(function (e) {
...
var s = function (e, r, t) {
  ...
  m = react__WEBPACK_IMPORTED_MODULE_0__.memo(function (o) {
    var a = o.onMove,
      l = o.onKey,
      s = c(o, ["onMove", "onKey"]),
      ...
      g = i(a),
      p = i(l),
      b = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),
      _ = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(!1),
      x = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
        var e = function (e) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      return H;
    }, [H]), react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", u({}, s, {
      onTouchStart: C,
      onMouseDown: C,
  ...
  S = react__WEBPACK_IMPORTED_MODULE_0__.memo(function (r) {
    var t = r.hue,
      n = r.onChange,
      o = g(["react-colorful__hue", r.className]);
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: o
    }, react__WEBPACK_IMPORTED_MODULE_0__.createElement(m, {
      onMove: function (e) {
        n({
          h: 360 * e.left
        });
  ...
  T = react__WEBPACK_IMPORTED_MODULE_0__.memo(function (r) {
    var t = r.hsva,
      n = r.onChange,
      o = {
        backgroundColor: q({
...
function Y(e, t, l) {
  var u = i(l),
    c = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(function () {
      return e.toHsva(t);
    }),
    s = c[0],
    f = c[1],
  ...
  }, [t, e]), (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var r;
...
var R,
  V = "undefined" != typeof window ? react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_0__.useEffect,
  $ = function () {
  ...
  U = function (t) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", u({}, s, {
      ref: f,
      className: m
  ...
  Z = function (r) {
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(U, u({}, r, {
      colorModel: W
    }));
  },
  ee = function (r) {
  ...
  ne = function (r) {
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(re, u({}, r, {
      colorModel: te
    }));
  },
  oe = {
  ...
  ke = function (r) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      _(v(l));
    }, [l, v]), react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", u({}, g, {
      value: h ? h(b) : b,
      spellCheck: "false",
      onChange: E,
      onBlur: H
  ...
  Oe = function (r) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(ke, u({}, o, {
      escape: l,
      format: t ? Ie : void 0,
      process: Ie,
      validate: i
