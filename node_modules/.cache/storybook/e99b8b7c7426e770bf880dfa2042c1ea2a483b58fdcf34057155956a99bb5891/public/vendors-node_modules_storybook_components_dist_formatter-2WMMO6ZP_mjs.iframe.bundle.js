"use strict";
(self["webpackChunkexample_component_library"] = self["webpackChunkexample_component_library"] || []).push([["vendors-node_modules_storybook_components_dist_formatter-2WMMO6ZP_mjs"],{
...
/* harmony export */ });
/* harmony import */ var _Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
...
var Fe = Xs,
  Js = t8 => new Intl.ListFormat("en-US", {
    type: "disjunction"
  }).format(t8);
function Zs(t8) {
...
var Pe = oi,
  ui = new Set(["sourceSpan", "startSourceSpan", "endSourceSpan", "nameSpan", "valueSpan", "keySpan", "tagDefinition", "tokens", "valueTokens"]),
...
function pi(t8, e) {
  if (e) return t8.find(({
    ...
    aliases: r
  }) => r?.includes(e)) ?? t8.find(({
    extensions: r
  }) => r?.includes(`.${e}`));
}
function hi(t8, e) {
  let r = t8.plugins.flatMap(s => s.languages ?? []),
    n = pi(r, e.language) ?? pn(r, e.physicalFile) ?? pn(r, e.file) ?? (e.physicalFile, void 0);
  return n?.parsers[0];
}
var Ne = hi,
  hn = "inline",
...
function _n(t8, e) {
  ...
  return r;
  function n() {
    return Pe(t8) || t8.type === "angularControlFlowBlock" ? !1 : (t8.type === "text" || t8.type === "interpolation") && t8.prev && (t8.prev.type === "text" || t8.prev.type === "interpolation") ? !0 : !t8.parent || t8.parent.cssDisplay === "none" ? !1 : ge(t8.parent) ? !0 : !(!t8.prev && (t8.parent.type === "root" || ge(t8) && t8.parent || V(t8.parent) || Ke(t8.parent, e) || !Ai(t8.parent.cssDisplay)) || t8.prev && !yi(t8.prev.cssDisplay));
  }
}
function En(t8, e) {
  return Pe(t8) || t8.type === "angularControlFlowBlock" ? !1 : (t8.type === "text" || t8.type === "interpolation") && t8.next && (t8.next.type === "text" || t8.next.type === "interpolation") ? !0 : !t8.parent || t8.parent.cssDisplay === "none" ? !1 : ge(t8.parent) ? !0 : !(!t8.next && (t8.parent.type === "root" || ge(t8) && t8.parent || V(t8.parent) || Ke(t8.parent, e) || !Di(t8.parent.cssDisplay)) || t8.next && !vi(t8.next.cssDisplay));
}
function An(t8) {
...
function xn(t8, e) {
  ...
  let r = !1;
  if (t8.type === "element" && t8.namespace === "svg") if (bi(t8, s => s.fullName === "svg:foreignObject")) r = !0;else return t8.name === "svg" ? "inline-block" : "block";
  ...
  t8.walk(e => {
    ...
    if (!r) for (let s = 0; s < e.children.length; s++) {
      ...
      let {
        ...
        p = i.prev,
        l = i.next;
      o ? (i.value = o, i.sourceSpan = new f(i.sourceSpan.start.moveBy(a.length), i.sourceSpan.end.moveBy(-u.length)), a && (p && (p.hasTrailingSpaces = !0), i.hasLeadingSpaces = !0), u && (i.hasTrailingSpaces = !0, l && (l.hasLeadingSpaces = !0))) : (e.removeChild(i), s--, (a || u) && (p && (p.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)));
    }
...
function _Ui() {
  _Ui = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (t8, e) {
    if (t8.lang === "yaml") {
      let r = t8.value.trim(),
        n = r ? yield e(r, {
          parser: "yaml"
...
function ji(t8, e, r) {
  ...
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && Yi(n.prev.value),
    ...
    a = t8.map(({
      node: d
    }) => i(d) ? T(e.originalText.slice(se(d), ie(d))) : r(), "attrs"),
...
function na(t8) {
  ...
  function m() {
    for (p(Ji), s = "", i = "in descriptor";;) {
      if (a = t8.charAt(o), i === "in descriptor") {
        if (Hn(a)) s && (n.push(s), s = "", i = "after descriptor");else if (a === ",") {
          o += 1, s && n.push(s), d();
          return;
        } else if (a === "(") s += a, i = "in parens";else if (a === "") {
          s && n.push(s), d();
          return;
        } else s += a;
      } else if (i === "in parens") {
        if (a === ")") s += a, i = "in descriptor";else if (a === "") {
          n.push(s), d();
          return;
        } else s += a;
  ...
  function d() {
    let C = !1,
      ...
      w2,
      q2;
    for (B = 0; B < n.length; B++) g = n[B], y2 = g[g.length - 1], $ = g.substring(0, g.length - 1), w2 = parseInt($, 10), q2 = parseFloat($), Vn.test($) && y2 === "w" ? ((_2 || D) && (C = !0), w2 === 0 ? C = !0 : _2 = w2) : ra.test($) && y2 === "x" ? ((_2 || D || P2) && (C = !0), q2 < 0 ? C = !0 : D = q2) : Vn.test($) && y2 === "h" ? ((P2 || D) && (C = !0), w2 === 0 ? C = !0 : P2 = w2) : C = !0;
    if (!C) c.source = {
      value: r,
      startOffset: u
    }, _2 && (c.width = {
      ...
      value: P2
    }), l.push(c);else throw new Error(`Invalid srcset descriptor found in "${t8}" at "${g}".`);
  }
}
var Un = na;
function De(t8, e = !0) {
...
function _x7() {
  _x7 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (t8, e, r, n) {
    r = {
...
function Yn(t8, e) {
  let {
    ...
    n = L(t8.node).trim();
  if (r.fullName === "style" && !e.parentParser && !n.includes("{{")) return /*#__PURE__*/function () {
    var _ref = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (s) {
      return De(yield s(n, {
        parser: "css",
...
function jn(_x9, _x10, _x11, _x12) {
  return _jn.apply(this, arguments);
}
function _jn() {
  _jn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (t8, e, r, n) {
    let s = L(r.node),
      {
        left: i,
        operator: a,
      ...
      u = $e(r, n);
    return [E(yield x(`function _(${i}) {}`, t8, {
...
function la(t8, e) {
  ...
  let s = L(r),
    i = $e(t8, e);
  if (Bn(r) || Ln(r, e)) return a => Qn(s, a, {
    parseWithTs: i
  });
  if (n.startsWith("@") || n.startsWith("v-on:")) return a => ca(s, a, {
    parseWithTs: i
  });
  if (n.startsWith(":") || n.startsWith("v-bind:")) return a => pa(s, a, {
    parseWithTs: i
  });
  if (n.startsWith("v-")) return a => Jn(s, a, {
    parseWithTs: i
  });
}
function ca(t8, e, {
...
var Zn = la,
  Sr = /{{(.+?)}}/s;
function es(_x13, _x14) {
  return _es.apply(this, arguments);
}
function _es() {
  _es = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (t8, e) {
    let r = [];
    for (let [n, s] of t8.split(Sr).entries()) if (n % 2 === 0) r.push(T(s));else try {
      r.push(E(["{{", R([A, yield x(s, e, {
...
function Ca(t8) {
  return /*#__PURE__*/function () {
    var _ref2 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, r, n, s) {
      let i = yield t8(e, r, n, s);
...
function Ea(t8, e) {
  ...
  switch (r.type) {
    case "element":
      ...
      if (!r.isSelfClosing && Dt(r, e)) {
        ...
        return n ? ( /*#__PURE__*/function () {
          var _ref3 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (s, i) {
            let a = Ft(r, e),
              o = /^\s*$/.test(a),
              u = "";
            return o || (u = yield s(ar(a), {
              parser: n,
              __embeddedInHtml: !0
            }), o = u === ""), [W(r, e), E(et(t8, e, i)), o ? "" : S, u, o ? "" : S, Qe(r, e), U(r, e)];
          });
    ...
    case "text":
      if (V(r.parent)) {
        let n = lr(r.parent, e);
        if (n) return /*#__PURE__*/function () {
          var _ref4 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (s) {
      ...
      } else if (r.parent.type === "interpolation") return /*#__PURE__*/function () {
        var _ref5 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (n) {
          let s = {
            __isInHtmlInterpolation: !0,
            __embeddedInHtml: !0
          };
          return e.parser === "angular" ? (s.parser = "__ng_interpolation", s.trailingComma = "none") : e.parser === "vue" ? s.parser = $e(t8, e) ? "__vue_ts_expression" : "__vue_expression" : s.parser = "__js_expression", [R([A, yield n(r.value, s)]), r.parent.next && j(r.parent.next) ? " " : A];
        });
...
function Oe(t8, e, r) {
  ...
  return t8.map((i, a) => {
    ...
    return d && (Ye(o.prev) ? u.push(S, S) : d === S ? u.push(S) : N(o.prev) ? p.push(d) : p.push(fe("", b, {
      groupId: s[a - 1]
    }))), C && (Ye(o) ? N(o.next) && m.push(S, S) : C === S ? N(o.next) && m.push(S) : l.push(C)), [...u, E([...p, E([rt(i, e, r), ...l], {
      id: s[a]
    })]), ...m];
  }, "children");
}
function is(t8, e, r) {
  ...
  let s = n.children.length === 1 && n.firstChild.type === "interpolation" && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces,
    ...
    o = l => s ? tn(l, {
      groupId: i
    }) : (V(n) || Ke(n, e)) && n.parent.type === "root" && e.parser === "vue" && !e.vueIndentScriptAndStyle ? l : R(l),
    u = () => s ? fe(b, "", {
      groupId: i
    }) : n.firstChild.hasLeadingSpaces && n.firstChild.isLeadingSpaceSensitive ? A : n.firstChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive ? Zr(b) : b,
    p = () => (n.next ? j(n.next) : Ee(n.parent)) ? n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? " " : "" : s ? fe(b, "", {
      groupId: i
...
var as = new Map([["if", new Set(["else if", "else"])], ["else if", new Set(["else if", "else"])], ["for", new Set(["empty"])], ["defer", new Set(["placeholder", "error", "loading"])], ["placeholder", new Set(["placeholder", "error", "loading"])], ["error", new Set(["placeholder", "error", "loading"])], ["loading", new Set(["placeholder", "error", "loading"])]]);
function os(t8, e, r) {
  let {
      node: n
    } = t8,
  ...
  let i = us(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = !0, n.lastChild.hasTrailingSpaces = !0, s.push(R([S, Oe(t8, e, r)])), i && s.push(S, "}")) : i && s.push("}"), E(s, {
    shouldBreak: !0
  });
}
function us(t8) {
...
var Rt = class {},
  ...
  $t = class extends Rt {
    constructor() {
      super(), this._schema = new Map(), this._eventSchema = new Map(), Fa.forEach(e => {
        let r = new Map(),
          n = new Set(),
          [s, i] = e.split("|"),
          a = i.split(","),
    ...
    hasElement(e, r) {
      return r.some(n => n.name === Dr.name) || e.indexOf("-") > -1 && (vr(e) || yr(e) || r.some(n => n.name === Ar.name)) ? !0 : this._schema.has(e.toLowerCase());
    }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`
    ...
    normalizeAnimationStyleValue(e, r, n) {
      let s = "",
        i = n.toString().trim(),
        a = null;
      if (Na(e) && n !== 0 && n !== "0") if (typeof n == "number") s = "px";else {
        let o = n.match(/^[+-]?[\d\.]+([a-z]*)$/);
...
var pt = class {
  ...
  Pr = class {
    constructor(e, r, n) {
      ...
      this._cursor = n.escapedString ? new Nr(e, s) : new Kt(e, s), this._preserveLineEndings = n.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = n.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = n.tokenizeBlocks ?? !0;
      try {
        this._cursor.init();
      } catch (i) {
        this.handleError(i);
...
`);
    ...
    _consumeBlockStart(e) {
      ...
      if (this._cursor.peek() === 40) if (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(k), this._attemptCharCode(41)) this._attemptCharCodeUntilFn(k);else {
        r.type = 29;
        return;
      }
    ...
    _consumeBlockParameters() {
      for (this._attemptCharCodeUntilFn(ks); this._cursor.peek() !== 41 && this._cursor.peek() !== 0;) {
        ...
        for (; this._cursor.peek() !== 59 && this._cursor.peek() !== 0 || r !== null;) {
          ...
          if (s === 92) this._cursor.advance();else if (s === r) r = null;else if (r === null && dr(s)) r = s;else if (s === 40 && r === null) n++;else if (s === 41 && r === null) {
            if (n === 0) break;
            n > 0 && n--;
          }
    ...
    handleError(e) {
      if (e instanceof ht && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof pt) this.errors.push(e.error);else throw e;
    }
    _attemptCharCode(e) {
    ...
    _consumeEntity(e) {
      ...
      if (this._cursor.advance(), this._attemptCharCode(35)) {
        ...
        let n = this._cursor.clone();
        if (this._attemptCharCodeUntilFn(ao), this._cursor.peek() != 59) this._beginToken(e, r), this._cursor = n, this._endToken(["&"]);else {
    ...
    _consumeTagOpen(e) {
      ...
      this._handleFullNameStackForTagOpen(n, r), a === F.RAW_TEXT ? this._consumeRawTextWithTagClose(n, r, !1) : a === F.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, !0);
    }
    ...
    _consumeTagClose(e) {
      if (this._beginToken(3, e), this._attemptCharCodeUntilFn(k), this._allowHtmComponentClosingTags && this._attemptCharCode(47)) this._attemptCharCodeUntilFn(k), this._requireCharCode(62), this._endToken([]);else {
    ...
    _consumeExpansionFormStart() {
      ...
      if (this._i18nNormalizeLineEndingsInICUs) this._endToken([r]);else {
...
var Kt = class t3 {
  ...
  Nr = class t4 extends Kt {
    ...
    processEscapeSequence() {
      ...
      if (e() === 92) if (this.internalState = {
        ...this.state
      }, this.advanceState(this.internalState), e() === 110) this.state.peek = 10;else if (e() === 114) this.state.peek = 13;else if (e() === 118) this.state.peek = 11;else if (e() === 116) this.state.peek = 9;else if (e() === 98) this.state.peek = 8;else if (e() === 102) this.state.peek = 12;else if (e() === 117) {
  ...
  Qt = class {
    ...
    parse(e, r, n, s = !1, i) {
      let a = D => (P2, ...B) => D(P2.toLowerCase(), ...B),
  ...
  Or = class t6 {
    ...
    _collectExpansionExpTokens(e) {
      ...
      for (;;) {
        ...
        if (this._peek.type === 24) if (Ns(n, 20)) n.pop();else return this.errors.push(I.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
...
`) {
    ...
    _consumeEndTag(e) {
      ...
      if (r && this.getTagDefinition(r).isVoid) this.errors.push(I.create(r, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`));else if (!this._popContainer(r, z, e.sourceSpan)) {
    ...
    _consumeIncompleteBlock(e) {
      ...
      let n = this._peek.sourceSpan.fullStart,
        ...
        i = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart),
        a = new J(e.parts[0], r, [], s, i);
      this._pushContainer(a, !1), this._popContainer(null, J, null), this.errors.push(I.create(e.parts[0], s, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
    }
    _getContainer() {
...
function qr(t8, e = {}) {
  ...
  return co().parse(t8, "angular-html-parser", {
...
function Vs(t8, e, r) {
  ...
  if (n === "vue") {
    ...
    let g,
      ...
      $ = w2 => y2().rootNodes.find(({
        startSourceSpan: q2
      }) => q2 && q2.start.offset === w2.startSourceSpan.start.offset) ?? w2;
    for (let [w2, q2] of l.entries()) {
      let {
        endSourceSpan: Wr2,
        startSourceSpan: js
      } = q2;
      if (Wr2 === null) m = y2().errors, l[w2] = $(q2);else if (Ao(q2, r)) {
...
var lu = Object.create,
  ...
  We = (e, t8) => {
    for (var r in t8) $e2(e, r, {
      get: t8[r],
      enumerable: !0
    });
  },
  nr2 = (e, t8, r, n) => {
    if (t8 && typeof t8 == "object" || typeof t8 == "function") for (let o of Fu(t8)) !du.call(e, o) && o !== r && $e2(e, o, {
      get: () => t8[o],
      enumerable: !(n = fu(t8, o)) || n.enumerable
    });
    return e;
  },
  he2 = (e, t8, r) => (r = e != null ? lu(pu(e)) : {}, nr2(t8 || !e || !e.__esModule ? $e2(r, "default", {
    value: e,
    enumerable: !0
  }) : r, e)),
  Eu = e => nr2($e2({}, "__esModule", {
    value: !0
  }), e),
  Cu = (e, t8, r) => {
  ...
  or2 = Me2(gt2 => {
    ...
    ur2.prototype = {
      diff: function (t8, r) {
        ...
        if (d[0].newPos + 1 >= s && f2 + 1 >= D) return i([{
          value: this.join(r),
          count: r.length
        }]);
        function p() {
          for (var F2 = -1 * a; F2 <= a; F2 += 2) {
            ...
            if (!h2 || B && E2.newPos < C.newPos ? (m = yu(C), u.pushComponent(m.components, void 0, !0)) : (m = E2, m.newPos++, u.pushComponent(m.components, !0, void 0)), g = u.extractCommon(m, r, t8, F2), m.newPos + 1 >= s && g + 1 >= D) return i(gu(u, m.components, r, t8, u.useLongestToken));
            d[F2] = m;
          }
          a++;
        }
      ...
      pushComponent: function (t8, r, n) {
        ...
        o && o.added === r && o.removed === n ? t8[t8.length - 1] = {
          count: o.count + 1,
          added: r,
          removed: n
        } : t8.push({
  ...
  ir2 = Me2(ye => {
    Object.defineProperty(ye, "__esModule", {
      value: !0
    }), ye.diffArrays = _u, ye.arrayDiff = void 0;
    var Au = Bu(or2());
    function Bu(e) {
...
var no2,
  ...
  yn2 = Me2(Ft2 => {
    Object.defineProperty(Ft2, "__esModule", {
      value: !0
    }), Ft2.codeFrameColumns = gn2, Ft2.default = ao2;
    var dn2 = (pn2(), Eu(Fn2)),
      mn2 = oo2(Pe2(), !0);
    function hn2(e) {
    ...
    function io2(e) {
      if (e) {
        return jt2 != null || (jt2 = new mn2.default.constructor({
          enabled: !0,
          level: 1
        })), jt2;
      }
    ...
    function Do2(e, t8, r) {
      ...
      if (p) for (let F2 = 0; F2 <= p; F2++) {
        let m = F2 + s;
        if (!D) l[m] = !0;else if (F2 === 0) {
          let E2 = t8[m - 1].length;
          l[m] = [D, E2 - D + 1];
        } else if (F2 === p) l[m] = [0, c];else {
    ...
    function gn2(e, t8, r = {}) {
      let n = (r.highlightCode || r.forceColor) && (0, dn2.shouldHighlight)(r),
        ...
        f2 = String(a).length,
        l = (n ? (0, dn2.default)(e, r) : e).split(Cn2, a).slice(D, a).map((F2, m) => {
          let E2 = D + 1 + m,
            g = ` ${` ${E2}`.slice(-f2)} |`,
            h2 = c[E2],
            B = !c[E2 + 1];
...
var U2 = xu,
  ku = e => new Intl.ListFormat("en-US", {
    type: "disjunction"
  }).format(e);
function bu(e) {
  ...
  for (; o.length > 0;) {
    ...
    if (t8?.(u) !== !1) switch (i) {
      ...
      case x2:
        ...
        break;
      case _:
        if (n && u.expandedStates) for (let s = u.expandedStates.length, D = s - 1; D >= 0; --D) o.push(u.expandedStates[D]);else o.push(u.contents);
        break;
      case S2:
      case T2:
      case P:
      ...
      case _:
        {
          ...
          return i ? (i = i.map(n), s = i[0]) : s = n(s), t8({
            ...u,
            contents: s,
            expandedStates: i
          });
...
function Yu(e, t8, r) {
  return t8 === Number.NEGATIVE_INFINITY ? e.root || vr2() : t8 < 0 ? xt2(e, {
    type: "dedent"
  }, r) : t8 ? t8.type === "root" ? {
    ...e,
    root: e
  ...
  for (; r >= 0;) {
    ...
    switch (U2(c)) {
      ...
      case k2:
        {
          let d = br2(c);
          for (let f2 = d.length - 1; f2 >= 0; f2--) s.push({
            mode: a,
            doc: d[f2]
          });
          break;
...
`, o) : l;
      ...
      case j2:
        for (let F2 = l.length - 1; F2 >= 0; F2--) i.push({
          ind: f2,
          mode: p,
          doc: l[F2]
        });
          ...
          case R2:
            {
              ...
              let F2 = {
                ...
                m = n - u,
                E2 = a.length > 0;
              if (!l.break && Qe2(F2, i, m, E2, r)) i.push(F2);else if (l.expandedStates) {
      ...
      case k2:
        {
          ...
          Qe2({
            ...
            mode: K2,
            doc: [E2, C, rr2]
          }, [], F2, a.length > 0, r, !0) ? i.push(Q2, Z, g) : B ? i.push(Q2, $, g) : i.push(Q2, $, h2);
          break;
        }
      case x2:
      case P:
...
function J2(e) {
  ...
  if (Array.isArray(e)) {
    let r = [];
    for (let n of e) if (Array.isArray(n)) r.push(...J2(n));else {
      let o = J2(n);
      o !== "" && r.push(o);
    }
    return r;
...
function et2({
  ...
  let r = e.flatMap(o => o.languages ?? []),
    n = [];
  for (let o of $u(Object.assign({}, ...e.map(({
    options: u
  }) => u), Lr))) !t8 && o.deprecated || (Array.isArray(o.choices) && (t8 || (o.choices = o.choices.filter(u => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...Vu(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter(u => {
    var i;
...
function Wu(e, t8) {
  if (t8) return e.find(({
    name: r
  }) => r.toLowerCase() === t8) ?? e.find(({
    aliases: r
  }) => r?.includes(t8)) ?? e.find(({
    extensions: r
  }) => r?.includes(`.${t8}`));
}
function Uu(e, t8) {
  let r = e.plugins.flatMap(o => o.languages ?? []),
    n = Wu(r, t8.language) ?? Ir(r, t8.physicalFile) ?? Ir(r, t8.file) ?? (t8.physicalFile, void 0);
  return n?.parsers[0];
}
var Rr = Uu,
  te2 = {
...
var rt2 = (e, t8, {
    ...
    let u = [`Ignored unknown option ${Nt2.default.yellow(r.pair({
        key: e,
        value: t8
      }))}.`],
      i = Object.keys(o).sort().find(s => Ot2(e, s) < 3);
  ...
  ot2 = class extends w {
    ...
    expected(t8) {
      let {
        text: r,
        list: n
      } = t8.normalizeExpectedResult(this._valueSchema.expected(t8));
      return {
...
function St2(e) {
  ...
  return Hu((t8 || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? {
    text: t8,
    list: {
      title: r.title,
      values: r.values.map(St2)
    }
  } : {
    text: t8
  };
...
var Dt2 = class extends w {
    constructor(t8) {
      super(t8), this._choices = Jr2(t8.choices.map(r => r && typeof r == "object" ? r : {
        value: r
      }), "value");
    }
    expected({
      ...
      let r = Array.from(this._choices.keys()).map(i => this._choices.get(i)).filter(({
          hidden: i
        }) => !i).map(i => i.value).sort(en2).map(t8.value),
        n = r.slice(0, -2),
        o = r.slice(-2);
      return {
  ...
  lt = class {
    constructor(t8, r) {
      ...
      }, this._unknownHandler = i, this._invalidHandler = tn2(s), this._deprecatedHandler = D, this._identifyMissing = (p, l) => !(p in l) || a(p, l), this._identifyRequired = c, this._preprocess = d, this._postprocess = f2, this.cleanHistory();
    }
    cleanHistory() {
      ...
      for (let i of o) {
        ...
        let a = ({
          ...
          c = ({
            ...
            if (F2 !== !1) if (F2 === !0) this._hasDeprecationWarned(i) || this._utils.logger.warn(this._deprecatedHandler(i, l, this._utils));else for (let {
              value: m
            } of F2) {
              let E2 = {
                key: i,
...
function Ju(e, t8, {
  ...
  let s = o ? Array.isArray(o) ? (f2, p) => o.includes(f2) ? {
      [f2]: p
    } : void 0 : (f2, p) => ({
      [f2]: p
    }) : (f2, p, l) => {
...
function Zu(e, {
  ...
  switch (e.type) {
    ...
    case "string":
      ...
      break;
    case "choice":
      i = Dt2, u.choices = e.choices.map(D => D != null && D.redirect ? {
        ...D,
        redirect: {
          to: {
            key: e.name,
...
function _Qu() {
  _Qu = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8 = {}) {
    var d;
    let r = {
      ...e
    };
    if (!r.parser) if (r.filepath) {
      ...
      }), !r.parser) throw new ve2(`No parser could be inferred for file "${r.filepath}".`);
    ...
    return r.parser === "json" && (r.trailingComma = "none"), sn2(r, n, {
      passThrough: Object.keys(cn2),
      ...t8
    });
  });
  return _Qu.apply(this, arguments);
...
var fn2 = ro2,
  An2 = he2(yn2(), 1);
function co2(_x24, _x25) {
  return _co.apply(this, arguments);
}
function _co() {
  _co = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let r = yield ft2(t8),
      n = r.preprocess ? r.preprocess(e, t8) : e;
    t8.originalText = n;
    let o;
    try {
      o = yield r.parse(n, t8, t8);
    } catch (u) {
      lo2(u, e);
    }
    return {
...
function Nn2(e, t8) {
  ...
  for (let [p, l] of f2.entries()) {
    ...
    let $;
    if (i ? $ = [l] : (F2.enclosingNode = E2, F2.precedingNode = m, F2.followingNode = C, $ = [F2, g, h2, B, Z]), Co2(g, h2, f2, p)) F2.placement = "ownLine", a(...$) || (C ? ne2(C, F2) : m ? ue2(m, F2) : X2(E2 || B, F2));else if (ho2(g, h2, f2, p)) F2.placement = "endOfLine", c(...$) || (m ? ue2(m, F2) : C ? ne2(C, F2) : X2(E2 || B, F2));else if (F2.placement = "remaining", !d(...$)) if (m && C) {
      let Q2 = n.length;
...
function wn2(e, t8) {
  ...
  for (i = r; i > 0; --i) {
    ...
    if (((D = (s = t8.printer).isGap) == null ? void 0 : D.call(s, f2, t8)) ?? /^[\s(]*$/.test(f2)) u = t8.locStart(a);else break;
  }
  for (let [a, {
    comment: c
  }] of e.entries()) a < i ? ue2(n, c) : ne2(o, c);
...
function Ao2(e, t8, r) {
  ...
  if (r != null && r.hasLineSuffix && !(r != null && r.isBlock) || V2(i, s(n), {
    backwards: !0
  })) {
    let c = Ye2(i, s(n));
    return {
...
function Ln2(_x26, _x27, _x28, _x29, _x30) {
  return _Ln.apply(this, arguments);
}
function _Ln() {
  _Ln = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8, r, n, o) {
    let {
...
function _o2(_x31, _x32, _x33, _x34) {
  return _o3.apply(this, arguments);
}
function _o3() {
  _o3 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8, r, n) {
    let o = yield re2({
        ...r,
        ...t8,
...
var Rn2 = ko;
function je2(_x35, _x36) {
  return _je.apply(this, arguments);
}
function _je() {
  _je = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    ({
      ast: e
    } = yield Ht2(e, t8));
    let r = new Map(),
      n = new Bn2(e),
      u = new Map();
    yield Ln2(n, s, t8, je2, u);
    let i = yield Yn2(n, t8, s, void 0, u);
    return Pn(t8), i;
    function s(a, c) {
...
function Ht2(_x37, _x38) {
  return _Ht.apply(this, arguments);
}
function _Ht() {
  _Ht = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let r = e.comments ?? [];
    t8[Symbol.for("comments")] = r, t8[Symbol.for("tokens")] = e.tokens ?? [], t8[Symbol.for("printedComments")] = new Set(), Nn2(e, t8);
    let {
      printer: {
        preprocess: n
      }
    } = t8;
    return e = n ? yield n(e, t8) : e, {
      ast: e,
      comments: r
    };
  });
...
function jn2(e) {
  ...
  for (;;) {
    let r = e[t8];
    if (r?.type === "Program" || r?.type === "File") t8--;else break;
  }
...
function Oo(e, t8, {
  ...
  let i = r(e.node);
  for (let D of jn2(t8.parentNodes)) if (r(D) >= i) u = D;else break;
  let s = n(t8.node);
  for (let D of jn2(e.parentNodes)) {
    if (n(D) <= s) o = D;else break;
    if (o === u) break;
  }
  return {
    startNode: o,
...
var $n2 = new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]),
  To2 = new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
function Vn2(e, t8, r) {
  if (!t8) return !1;
  switch (e.parser) {
    case "flow":
...
var Wn2 = So2,
  Hn2 = "\uFEFF",
  Un2 = Symbol("cursor");
function qn2(_x39, _x40) {
  return _qn.apply(this, arguments);
}
function _qn() {
  _qn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8, r = 0) {
    ...
    if (t8.cursorOffset >= 0) {
      let D, a, c, d, f2;
      if (t8.cursorNode && i.cursorNodeText ? (D = t8.locStart(t8.cursorNode), a = o.slice(D, t8.locEnd(t8.cursorNode)), c = t8.cursorOffset - D, d = i.cursorNodeStart, f2 = i.cursorNodeText) : (D = 0, a = o, c = t8.cursorOffset, d = 0, f2 = i.formatted), a === f2) return {
...
function vo2(_x41, _x42) {
  return _vo.apply(this, arguments);
}
function _vo() {
  _vo = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let {
        ast: r,
        text: n
      } = yield De2(e, t8),
...
function zn2(e, t8) {
  ...
  return r = Jt2(e, r, -1), n = Jt2(e, n, 0), o = Jt2(e, o, e.length), {
    ...t8,
    cursorOffset: r,
    rangeStart: n,
    rangeEnd: o
...
function Gn2(_x43, _x44) {
  return _Gn.apply(this, arguments);
}
function _Gn() {
  _Gn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let r = yield ft2(t8);
    return !r.hasPragma || r.hasPragma(e);
  });
  return _Gn.apply(this, arguments);
}
function Xt2(_x45, _x46) {
  return _Xt.apply(this, arguments);
}
function _Xt() {
  _Xt = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let {
      hasBOM: r,
      text: n,
      options: o
    } = Jn2(e, yield re2(t8));
    if (o.rangeStart >= o.rangeEnd && n !== "" || o.requirePragma && !(yield Gn2(n, o))) return {
      formatted: e,
      cursorOffset: t8.cursorOffset,
      comments: []
    };
    let u;
    return o.rangeStart > 0 || o.rangeEnd < n.length ? u = yield vo2(n, o) : (!o.requirePragma && o.insertPragma && o.printer.insertPragma && !(yield Gn2(n, o)) && (n = o.printer.insertPragma(n)), u = yield qn2(n, o)), r && (u.formatted = Hn2 + u.formatted, u.cursorOffset >= 0 && u.cursorOffset++), u;
  });
  return _Xt.apply(this, arguments);
}
function Xn2(_x47, _x48, _x49) {
  return _Xn.apply(this, arguments);
}
function _Xn() {
  _Xn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8, r) {
    let {
        text: n,
        options: o
      } = Jn2(e, yield re2(t8)),
      u = yield De2(n, o);
    return r && (r.preprocessForPrint && (u.ast = yield Ht2(u.ast, o)), r.massage && (u.ast = fn2(u.ast, o))), u;
  });
  return _Xn.apply(this, arguments);
}
function Zn2(_x50, _x51) {
  return _Zn.apply(this, arguments);
}
function _Zn() {
  _Zn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    t8 = yield re2(t8);
    let r = yield je2(e, t8);
    return fe2(r, t8);
  });
  return _Zn.apply(this, arguments);
}
function Qn2(_x52, _x53) {
  return _Qn.apply(this, arguments);
}
function _Qn() {
  _Qn = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let r = Pr2(e),
      {
        formatted: n
      } = yield Xt2(r, {
...
function eu(_x54, _x55) {
  return _eu.apply(this, arguments);
}
function _eu() {
  _eu = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    t8 = yield re2(t8);
    let {
      ast: r
    } = yield De2(e, t8);
...
function tu(_x56, _x57) {
  return _tu.apply(this, arguments);
}
function _tu() {
  _tu = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    return fe2(e, yield re2(t8));
  });
  return _tu.apply(this, arguments);
}
var Qt2 = {};
...
function Uo(e, t8, r) {
  let n = t8 === '"' ? "'" : '"',
    u = ee2(!1, e, /\\(.)|(["'])/gs, (i, s, D) => s === n ? s : D === t8 ? "\\" + D : D || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(s) ? s : "\\" + s));
  return t8 + u + t8;
}
var su = Uo;
function zo(e, t8, r) {
...
var Xo = {
  ...
  Du = "3.1.1";
function ae(e, t8 = 1) {
  return /*#__PURE__*/(0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (...r) {
    let n = r[t8] ?? {},
      o = n.plugins ?? [];
    return r[t8] = {
      ...n,
...
var au = ae(Xt2);
function cu(_x58, _x59) {
  return _cu.apply(this, arguments);
}
function _cu() {
  _cu = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    let {
      formatted: r
    } = yield au(e, {
      ...t8,
...
function ei2(_x60, _x61) {
  return _ei.apply(this, arguments);
}
function _ei() {
  _ei = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (e, t8) {
    return (yield cu(e, t8)) === e;
  });
  return _ei.apply(this, arguments);
}
var ti2 = ae(et2, 0),
...
var formatter = memoizerific__WEBPACK_IMPORTED_MODULE_0___default()(2)( /*#__PURE__*/function () {
  var _ref7 = (0,_Users_paramdeepsingh_Desktop_Angular_Refresher_StoryBooks_example_component_library_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (type, source) {
    return type === !1 ? source : type === "dedent" || type === !0 ? dedent(source) : (yield qc.format(source, {
      parser: type,
      plugins: [dh],
